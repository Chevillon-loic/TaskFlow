/******/ (function(modules) {
            ...
            /***/ function(module, __webpack_exports__, __webpack_require__) {
                ...
                try {
                    var _loop2 = function _loop2() {
                        ...
                        var divModalTicket = ticket.querySelector(
                            "#modalContainerTicket"
                        );
                        var cancelRemoveTicket = ticket.querySelector(
                            "#cancelRemoveTicket"
                        );
                        ...
                        cancelRemoveTicket.addEventListener("click", function(
                            e
                        ) {
                            divModalTicket.style.display = "none";
                        });
                        var commentModal = ticket.querySelector(
                            "#modalContainerComment"
                        );
                        var cancelComment = ticket.querySelector(
                            ".cancelComment"
                        );
                        ...
                        hTitleTicket.addEventListener("click", function(e) {
                            var input = document.createElement("input");
                            hTitleTicket.insertAdjacentElement(
                                "beforebegin",
                                input
                            );
  ...
  \**************************************/
            ...
            /***/ function(module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! /var/www/taskflow.webo/resources/js/ticket.js */ "./resources/js/ticket.js"
                );
